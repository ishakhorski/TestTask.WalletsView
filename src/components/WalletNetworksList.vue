...
const visibleNetworks = computed(() =>
    props.networks.length > props.max
        ? props.networks.slice(0, props.max - 1)
        : props.networks
)
</script>
...
<template>
    <div class="wallet-networks">
        ...
        <div v-if="props.networks.length > 3" class="wallet-networks__item wallet-networks__item--count">
